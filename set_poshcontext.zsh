...
# in your .zshrc, because Oh My Posh defines an empty stub that would
# override it otherwise.
#
# Usage: Add the following to your .zshrc AFTER the oh-my-posh init line:
#   source /path/to/set_poshcontext.zsh
